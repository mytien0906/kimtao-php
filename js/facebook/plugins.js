/*
 * carousel.min.js FOR ACCESSORY SLIDER IN HOME PAGE : AJAX carousel.action.accessory.js
        ...
        animate: function(t, n) {
            ...
            if (!this.options.animation || n === false) {
            	...
            	/*if(this.options.vertical === false 
            		...
            		|| this.options.scroll === 1) {

            		if($(window).width() < 992) {
            			t = this.list.closest('div').width();
            		}
            	}*/
 ...
 */
(function(e){e.jscroll={defaults:{debug:false,autoTrigger:true,autoTriggerUntil:false,loadingHtml:"<small>Loading...</small>",padding:0,nextSelector:"a:last",contentSelector:"",pagingSelector:"",callback:false}};var t=function(t,n){function r(){var t=e(d.loadingHtml).filter("img").attr("src");if(t){var n=new Image;n.src=t}}function i(){if(!t.find(".jscroll-inner").length){t.contents().wrapAll('<div class="jscroll-inner" />')}}function s(e){if(d.pagingSelector){var t=e.closest(d.pagingSelector).hide()}else{var t=e.parent().not(".jscroll-inner,.jscroll-added").addClass("jscroll-next-parent").hide();if(!t.length){e.wrap('<div class="jscroll-next-parent" />').parent().hide()}}}function o(){return b.unbind(".jscroll").removeData("jscroll").find(".jscroll-inner").children().unwrap().filter(".jscroll-added").children().unwrap()}function u(){i();var e=t.find("div.jscroll-inner").first(),n=t.data("jscroll"),r=parseInt(t.css("borderTopWidth")),s=isNaN(r)?0:r,o=parseInt(t.css("paddingTop"))+s,u=v?b.scrollTop():t.offset().top,a=e.length?e.offset().top:0,f=Math.ceil(u-a+b.height()+o);if(!n.waiting&&f+d.padding>=e.outerHeight()){c("info","jScroll:",e.outerHeight()-f,"from bottom. Loading next request...");return l()}}function a(e){e=e||t.data("jscroll");if(!e||!e.nextHref){c("warn","jScroll: nextSelector not found - destroying");o();return false}else{f();return true}}function f(){var e=t.find(d.nextSelector).first();if(d.autoTrigger&&(d.autoTriggerUntil===false||d.autoTriggerUntil>0)){s(e);if(y.height()<=g.height()){u()}b.unbind(".jscroll").bind("scroll.jscroll",function(){return u()});if(d.autoTriggerUntil>0){d.autoTriggerUntil--}}else{b.unbind(".jscroll");e.bind("click.jscroll",function(){s(e);l();return false})}}function l(){var n=t.find("div.jscroll-inner").first(),r=t.data("jscroll");if(r.nextHref==undefined||r.nextHref=="undefined"){return}r.waiting=true;n.append('<div class="jscroll-added" />').children(".jscroll-added").last().html('<div class="jscroll-loading">'+d.loadingHtml+"</div>");return t.animate({scrollTop:n.outerHeight()},0,function(){n.find("div.jscroll-added").last().load(r.nextHref,function(n,i,s){if(i==="error"){return o()}var u=e(this).find(d.nextSelector).first();r.waiting=false;r.nextHref=u.attr("href")?e.trim(u.attr("href")+" "+d.contentSelector):false;e(".jscroll-next-parent",t).remove();a();if(d.callback){r.nextObj=u;d.callback.call(this,r)}c("dir",r)})})}function c(e){if(d.debug&&typeof console==="object"&&(typeof e==="object"||typeof console[e]==="function")){if(typeof e==="object"){var t=[];for(var n in e){if(typeof console[n]==="function"){t=e[n].length?e[n]:[e[n]];console[n].apply(console,t)}else{console.log.apply(console,t)}}}else{console[e].apply(console,Array.prototype.slice.call(arguments,1))}}}var h=t.data("jscroll"),p=typeof n==="function"?{callback:n}:n,d=e.extend({},e.jscroll.defaults,p,h||{}),v=t.css("overflow-y")==="visible",m=t.find(d.nextSelector).first(),g=e(window),y=e("body"),b=v?g:t,w=e.trim(m.attr("href")+" "+d.contentSelector);t.data("jscroll",e.extend({},h,{initialized:true,waiting:false,nextHref:w}));i();r();f();e.extend(t.jscroll,{destroy:o});return t};e.fn.jscroll=function(n){return this.each(function(){var r=e(this),i=r.data("jscroll");if(i&&i.initialized)return;var s=new t(r,n)})}})(jQuery);
...
/* ==================================================================== */
// Check Type of DATA collections
// Collected by minhnguyenwp
// 06.2015
/* ==================================================================== */
var checkit = {
...
// isRetina
checkit.isRetina = window.devicePixelRatio > 1;
/* ==================================================================== */
...
var isMobile = {
    ...
    mobile: function() {
        return (isMobile.Android() || isMobile.BlackBerry() || isMobile.iOS() || isMobile.Opera() || isMobile.Windows() || screen.width < 540);
    },
    isMac: function() {
 ...
 */
$.fn.stickyFloat=function(e,t){var n=this;var r=parseInt(n.parent().css("padding-top"));var i=n.parent().offset().top;var s=$.extend({startOffset:i,offsetY:r,duration:200,lockBottom:true},e);n.css({position:"absolute"});if(s.lockBottom){var o=n.parent().height()-n.height()+r;if(o<0)o=0}$(window).scroll(function(){n.stop();var e=$(document).scrollTop()>s.startOffset;var t=n.offset().top>i;var u=n.outerHeight()<$(window).height();if((e||t)&&u){var a=$(document).scrollTop()-i+s.offsetY;if(a>o)a=o;if($(document).scrollTop()<s.startOffset)a=r;n.css({top:a})}})};
/* ========================================================================
...
/* pwFixedBanner */
(function(e,t,n){function i(t,n){this.element=e(t);this.options=e.extend({},e.fn[r].defaults,n);this.init()}var r="pwFixedBanner";i.prototype={init:function(){var n=this;this.scrollObj();n.hideObj();e(t).resize(function(){n.hideObj()})},scrollObj:function(){var n=this;var r=e(".banner-adv-item",this.element);jQuery(t).scroll(function(){var i=e(t).scrollTop();if(i>n.options.offsetTop){e(r).addClass("fixed")}else{e(r).removeClass("fixed")}if(i>e("footer").offset().top-r.height()-50){e(r).addClass("bottom")}else{e(r).removeClass("bottom")}})},hideObj:function(){var t=this;var n=e(".banner-adv-item",this.element);var r=e("body").width();var i=e(".wrapper").width()+n.width()*2+12;if(r<i+2){n.hide()}else{n.show()}},destroy:function(){e.removeData(this.element,r)}};e.fn[r]=function(t,n){return this.each(function(){var s=e.data(this,r);if(!s){e.data(this,r,new i(this,t))}else if(s[t]){s[t](n)}else{alert(t?t+" method is not exists in "+r:r+" plugin has been initialized")}})};e.fn[r].defaults={offsetTop:100}})(jQuery,window);(function(e){e.fn.extend({scrollTopObj:function(t){var n={topHeight:"",objMove:""};var t=e.extend(n,t);return this.each(function(){var n=t;var r=e(this);var i=jQuery(n.objMove).offset();e("body,html").animate({scrollTop:i.top-n.topHeight},800);return false})}})})(jQuery)+function(e){"use strict";function t(n,r){var i;var s=e.proxy(this.process,this);this.$element=e(n).is("body")?e(window):e(n);this.$body=e("body");this.$scrollElement=this.$element.on("scroll.bs.scroll-spy.data-api",s);this.options=e.extend({},t.DEFAULTS,r);this.selector=(this.options.target||(i=e(n).attr("href"))&&i.replace(/.*(?=#[^\s]+$)/,"")||"")+" ul li > a";this.offsets=e([]);this.targets=e([]);this.activeTarget=null;this.refresh();this.process()}t.DEFAULTS={offset:10};t.prototype.refresh=function(){var t=this.$element[0]==window?"offset":"position";this.offsets=e([]);this.targets=e([]);var n=this;var r=this.$body.find(this.selector).map(function(){var r=e(this);var i=r.data("target")||r.attr("href");var s=/^#\w/.test(i)&&e(i);return s&&s.length&&[[s[t]().top+(!e.isWindow(n.$scrollElement.get(0))&&n.$scrollElement.scrollTop()),i]]||null}).sort(function(e,t){return e[0]-t[0]}).each(function(){n.offsets.push(this[0]);n.targets.push(this[1])})};t.prototype.process=function(){var e=this.$scrollElement.scrollTop()+this.options.offset;var t=this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight;var n=t-this.$scrollElement.height();var r=this.offsets;var i=this.targets;var s=this.activeTarget;var o;if(e>=n){return s!=(o=i.last()[0])&&this.activate(o)}for(o=r.length;o--;){s!=i[o]&&e>=r[o]&&(!r[o+1]||e<=r[o+1])&&this.activate(i[o])}};t.prototype.activate=function(t){this.activeTarget=t;e(this.selector).parents(".active").removeClass("active");var n=this.selector+'[data-target="'+t+'"],'+this.selector+'[href="'+t+'"]';var r=e(n).parents("li").addClass("active");if(r.parent(".dropdown-menu").length){r=r.closest("li.dropdown").addClass("active")}r.trigger("activate")};var n=e.fn.scrollspy;e.fn.scrollspy=function(n){return this.each(function(){var r=e(this);var i=r.data("bs.scrollspy");var s=typeof n=="object"&&n;if(!i)r.data("bs.scrollspy",i=new t(this,s));if(typeof n=="string")i[n]()})};e.fn.scrollspy.Constructor=t;e.fn.scrollspy.noConflict=function(){e.fn.scrollspy=n;return this};e(window).on("load",function(){e('[data-spy="scroll"]').each(function(){var t=e(this);t.scrollspy(t.data())})})}(window.jQuery);
/* ========================================================================
