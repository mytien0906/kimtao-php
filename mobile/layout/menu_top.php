<div class="h1200">
    <ul class="clear">	
        ...
        <li><a class="<?php if($_REQUEST['com'] == 'gioi-thieu') echo 'active'; ?>" href="gioi-thieu.html"><?=_gioithieu?><i class="fa fa-angle-down" aria-hidden="true"></i></a></li>
         <li><a class="<?php if($_REQUEST['com'] == 'san-pham-dich-vu') echo 'active'; ?>" href="san-pham-dich-vu.html">sản phẩm, dịch vụ<i class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <li><a class="<?php if($_REQUEST['com'] == 'ket-cau-thep') echo 'active'; ?>" href="ket-cau-thep.html">kết cấu thép<i class="fa fa-angle-down" aria-hidden="true"></i></a>
        </li>
         <li><a class="<?php if($_REQUEST['com'] == 'bat-dong-san') echo 'active'; ?>" href="bat-dong-san.html">bất động sản<i class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <?php } ?>
         ...
         <li><a class="<?php if($_REQUEST['com'] == 'du-an') echo 'active'; ?>" href="du-an.html">dự án<i class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <li><a class="<?php if($_REQUEST['com'] == 'tuyen-dung') echo 'active'; ?>" href="tuyen-dung.html">tuyển dụng<i class="fa fa-angle-down" aria-hidden="true"></i></a></li>
    ...
    <div id="search">
        <input type="text" name="keyword" id="keyword" onKeyPress="doEnter(event,'keyword');" value="Tìm kiếm..." onclick="if(this.value=='<?=_nhaptukhoatimkiem?>...'){this.value=''}" onblur="if(this.value==''){this.value='<?=_nhaptukhoatimkiem?>...'}">
