<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=giasearch&act=add_giasearch"><span>Hình ảnh</span></a></li>
	...
	<div class="widget">
       ...
       <div id="info" class="tab_content">         
        	<div class="formRow">
            	<label>Tên: </label>
            	<div class="formRight">
                <input type="text" id="ten" name="ten" value=""  title="Nhập tên" class="tipS" />
            	</div>
            <div class="clear"></div>
        	</div>
            <div class="formRow">
            	<label>Giá Từ: </label>
            	<div class="formRight">
                <input type="text" id="giatu" name="giatu" value=""  title="Nhập giá từ" class="tipS" />
            	</div>
            <div class="clear"></div>
        	</div>   
            <div class="formRow">
            	<label>Giá đến: </label>
            	<div class="formRight">
                <input type="text" id="giaden" name="giaden" value=""  title="Nhập giá đến" class="tipS" />
            	</div>
            <div class="clear"></div>
        	</div>                                    
       <!-- End info -->
