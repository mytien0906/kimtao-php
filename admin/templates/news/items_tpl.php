...
<?php
	...
	{
		$sql_huyen="select * from table_news_danhmuc where hienthi=1 and type='".$_REQUEST['type']."' order by stt,id desc ";
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <td>
        ...
        <td align="center">
          <?php
				$sql = "select ten from table_news_danhmuc where id='".$items[$i]['id_danhmuc']."'";
        ...
        <td class="title_name_data">
            <a href="index.php?com=news&act=edit&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST['type']?><?php if($items[$i]['id_danhmuc']!='') echo'&id_danhmuc='.$items[$i]['id_danhmuc'];?><?php if($items[$i]['id_list']!='') echo'&id_list='.$items[$i]['id_list'];?>&hienthi=<?=$items[$i]['hienthi']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold"><?=$items[$i]['ten']?></a>
        </td>
        ...
        <td class="actBtns">
            <a href="index.php?com=news&act=edit&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST['type']?><?php if($items[$i]['id_danhmuc']!='') echo'&id_danhmuc='.$items[$i]['id_danhmuc'];?><?php if($items[$i]['id_list']!='') echo'&id_list='.$items[$i]['id_list'];?>&hienthi=<?=$items[$i]['hienthi']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" title="" class="smallButton tipS" original-title="Sửa bài viết"><img src="./images/icons/dark/pencil.png" alt=""></a>
