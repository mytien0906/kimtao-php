     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <input type="text" id="code_pro" name="soluong" value="<?=@$item['soluong']?>"  title="Nhập số lượng" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>
        <div class="formRow">
        ...
        <div class="formRow">
			...
			<div class="formRight">
				...
				<div class="note"> Height:600px | Width:600px  <?=_format_duoihinh_l?> </div>
			</div>
			<div class="clear"></div>
		</div>
 	...
 	<div class="formRow">
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <textarea  rows="8" cols="" title="Viết mô tả ngắn bài viết" class="ck_editor tipS" name="mota<?=$key?>" id="mota<?=$key?>"><?=@$item['mota'.$key]?></textarea>
            </div>
            <div class="clear"></div>
        </div>  
