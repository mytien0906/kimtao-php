        ...
        <div id="content_lang_<?=$key?>" class="tab_content">	
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <?php if($_REQUEST['type']=='logo') { ?><span class="size_img">Chiều rộng <b>99px</b> Chiều cao: <b>54px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='ten_cty') { ?><span class="size_img">Chiều rộng <b>366px</b> Chiều cao: <b>45px</b></span><?php } ?>
                     <?php if($_REQUEST['type']=='qc') { ?><span class="size_img">Chiều rộng <b>1366px</b> Chiều cao: <b>411px</b></span><?php } ?>
                </div>
                <div class="clear"></div>
             </div> 
        </div><!-- End content <?=$key?> -->
