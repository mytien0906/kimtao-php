	...
	<div class="widget">
       ...
       <div id="info" class="tab_content"> 
		...
		<div class="formRow">
			...
			<div class="formRight">
                ...
                <div class="note">  
					<?php if($_REQUEST['type']=='slider')echo 'Width:1366px - Height:580px '; ?> 
                    <?php if($_REQUEST['type']=='doitac')echo 'Width:160px - Height:110px '; ?>
					<?=_format_duoihinh_l?> 
                </div>
			</div>
			<div class="clear"></div>
       ...
       <?php foreach ($config['lang'] as $key => $value) {
        ...
        <div id="content_lang_<?=$key?>" class="tab_content">     
            ...
            <label>Mô tả 1</label>
                <div class="formRight">
                    <input type="text" name="mota<?=$key?>" title="Nhập mô tả ( <?=$key?> )" id="mota<?=$key?>" class="tipS validate[required]" value="<?=@$item['mota'.$key]?>" />
                </div>
                <div class="clear"></div>
            </div>
            ...
            <label>Mô tả 2</label>
                <div class="formRight">
                    <input type="text" name="mota1<?=$key?>" title="Nhập mô tả ( <?=$key?> )" id="mota1<?=$key?>" class="tipS validate[required]" value="<?=@$item['mota1'.$key]?>" />
                </div>
                <div class="clear"></div>
            </div>
        	<?php }//?>
