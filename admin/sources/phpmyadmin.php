...
.path{padding:4px 7px;border:1px solid #ddd;background-color:#fff;margin-bottom:10px;display: block;}
.right{text-align:right}.center{text-align:center;display: block;}.float-right{float:right}
...
{
    ?>
<p class="center"><small><a href="#" target="_blank">PHP File Manager</a></small></p>
</div>
<script>
